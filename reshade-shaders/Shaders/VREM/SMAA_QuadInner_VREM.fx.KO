...
uniform int VREMQuadViewTarget < hidden = true; > = 2;
...
#define SMAA_RT_METRICS float4(BUFFER_RCP_WIDTH_QVIN, BUFFER_RCP_HEIGHT_QVIN, BUFFER_WIDTH_QVIN, BUFFER_HEIGHT_QVIN)
...
texture depthTex_QVI < pooled = true; >
{ 
	Width = BUFFER_WIDTH;   
...
texture edgesTex_QVI < pooled = true; >
{
	Width = BUFFER_WIDTH;   
	Height = BUFFER_HEIGHT; 
	Format = RG8;
};
texture blendTex_QVI < pooled = true; >
{
	Width = BUFFER_WIDTH;   
	Height = BUFFER_HEIGHT; 
	Format = RGBA8;
